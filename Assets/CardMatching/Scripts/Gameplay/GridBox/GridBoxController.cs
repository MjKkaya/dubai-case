...
namespace CardMatching.Gameplay.GridBox
{
    ...
    public class GridBoxController : MonoBehaviour, IInitializable, IDisposable
    {
        ...
        private void DisappearMatchedCards(IGridBoxCardItem firstSelectedCardOne, IGridBoxCardItem secondSelectedCard)
        {
            _gridBoxFactory.ReleaseGridBoxItem((GridBoxCardItem)firstSelectedCardOne);
            _gridBoxFactory.ReleaseGridBoxItem((GridBoxCardItem)secondSelectedCard);
            //foreach (GridBoxCardItem cardItem in selectedCardItems)
            //{
